                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    <a href="{{ route('comment.show', $comment->id) }}"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="" data-toggle="modal"
                                                        data-target="#softdelete-{{ $comment->id }}"><i
                                                            class="fas fa-trash"></i></a>
                                                </div>

                                                <!-- Delete Modal -->
                                                <div class="modal fade effect-scale modal-dark"
                                                    id="softdelete-{{ $comment->id }}" tabindex="-1"
                                                    aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
                                                                <h5 class="modal-title" id="deleteModalLabel">Delete Comment
                                                                </h5>
