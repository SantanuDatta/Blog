                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Please Input Category Name" value="{{ $comment->user->name }}" readonly disabled>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" value="{{ $comment->user->email }}" readonly disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" id="">
                                            ...
                                            <option value="1" @if($comment->status == 1) selected @endif >Approve</option>
                                            <option value="0" @if($comment->status == 0) selected @endif >Disapprove</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" name="editComment" class="btn btn-teal float-right">Moderate Comment</button>
                                    </div>
                                </div>
