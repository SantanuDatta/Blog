                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Please Input Reader Name" value="{{ old('name') }}" required autofocus>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="addreader" class="btn btn-teal float-right">Add New Reader</button>
                                    </div>
                                </div>
