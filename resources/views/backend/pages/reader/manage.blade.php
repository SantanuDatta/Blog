                                                ...
                                                <td>
                                                    <div class="btn-group action-bar" role="group">
                                                        <a href="" data-toggle="modal"
                                                            data-target="#description-{{ $reader->id }}"><i
                                                                class="fas fa-eye"></i></a>
                                                        <a href="{{ route('reader.edit', $reader->id) }}"><i
                                                                class="fas fa-edit"></i></a>
                                                        <a href="" data-toggle="modal"
                                                            data-target="#softdelete-{{ $reader->id }}"><i
                                                                class="fas fa-trash"></i></a>
                                                    </div>
                                                    <!-- View Modal -->
                                                    <div class="modal fade effect-scale modal-dark"
                                                        id="description-{{ $reader->id }}" tabindex="-1"
                                                    ...
                                                    <!-- Delete Modal -->
                                                    <div class="modal fade effect-scale modal-dark"
                                                        id="softdelete-{{ $reader->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-content bd-0">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary btn-sm"
                                                                        data-dismiss="modal">Close</button>
                                                                    <form
                                                                        action="{{ route('reader.destroy', $reader->id) }}"
                                                                        method="POST">
                                                                        @csrf
