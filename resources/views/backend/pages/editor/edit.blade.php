            ...
            <div class="col-sm-12">
                <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                        <form action="{{ route('editor.update', $editor->id) }}" method="POST"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-dark"
                                            value="{{ $editor->email }}" disabled readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control form-control-dark" id="">
                                            ...
                                            <option value="1" @if ($editor->role == 1) selected @endif>Admin
                                            </option>
                                            <option value="2" @if ($editor->role == 2) selected @endif>Editor
                                            </option>
                                            <option value="3" @if ($editor->role == 3) selected @endif>Reader
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-dark" id="">
                                            ...
                                            <option value="1" @if ($editor->status == 1) selected @endif>Active
                                            </option>
                                            <option value="0" @if ($editor->status == 0) selected @endif>
                                                Inactive</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" name="editeditor" class="btn btn-teal float-right">Update
                                            Editor</button>
                                    </div>
                                </div>
