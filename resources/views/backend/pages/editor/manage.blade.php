                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group action-bar" role="group">
                                                        <a href="" data-toggle="modal" data-target="#description-{{ $editor->id }}"><i class="fas fa-eye"></i></a>
                                                        <a href="{{ route('editor.edit', $editor->id) }}"><i class="fas fa-edit"></i></a>
                                                        <a href="" data-toggle="modal" data-target="#softdelete-{{ $editor->id }}"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                    <!-- View Modal -->
                                                    <div class="modal fade effect-scale modal-dark" id="description-{{ $editor->id }}" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                    ...
                                                    <!-- Delete Modal -->
                                                    <div class="modal fade effect-scale modal-dark" id="softdelete-{{ $editor->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
