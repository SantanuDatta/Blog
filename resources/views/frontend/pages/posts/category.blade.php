    ...
    <section class="page-header">
        <div class="container-xl">
            <div class="text-center">
                <h1 class="mt-0 mb-2">{{ $cDetails->name }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $cDetails->name }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xl">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row gy-4">
                        @foreach (App\Models\Post::whereRaw("FIND_IN_SET($cDetails->id, category_id)")->where('status', 1)->orderBy('id', 'desc')->get() as $post)
                            <div class="col-sm-6">
                                <!-- post -->
                                <div class="post post-grid rounded bordered">
                                    ...
                                    <div class="details">
                                        ...
                                        <h5 class="post-title mb-3 mt-3"><a
                                                href="{{ route('singlePost', $post->slug) }}">{{ Str::limit($post->title, 40) }}</a>
                                        </h5>
                                    ...
                                    <div class="post-bottom clearfix d-flex align-items-center">
                                        ...
                                        <div class="more-button float-end">
                                            <a href="{{ route('singlePost', $post->slug) }}"><span
